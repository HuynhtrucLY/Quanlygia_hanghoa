...
<div class="container-fluid py-4">
    <div class="p-3 mb-4 bg-dark text-warning rounded shadow-sm">
        <h3 class="m-0 text-uppercase fs-5">📂 CHỈNH SỬA DANH MỤC</h3>
    </div>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <form action="{{ url('/categories/update/'.$category->ma_danh_muc) }}" method="POST">
                @csrf
...
<script>
    // Tự động ẩn lỗi validate sau 3 giây cho đồng bộ với các trang khác
    setTimeout(function() {
